...
function loadDataTable() {
    $.ajax({
        ...
        success: function (response) {
            ...
            const filteredData = response.data.filter(diet => diet.dietsCategory.categoryName === 'Dieta Karniworska');
            ...
            if (filteredData.length === 0) {
                console.warn('No diets match the category "Dieta Karniworska"');
            }
